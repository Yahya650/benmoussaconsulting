				...
				<div class="experiance-column col-lg-5 col-md-12 col-sm-12">
					<div class="inner-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="text-center">
							<a href="tel:+786-904-781-67" class="theme-btn phone-btn"><span class="icon flaticon-call"></span>+212 663-520502</a>
						</div>
					</div>
				</div>
								...
								<div class="feature-block">
									<div class="inner-box">
										<div class="content">
											...
											<div class="text">Ce type de coaching convient aux situations de prise de poste.</div>
										</div>
									</div>
								</div>
								...
								<div class="feature-block">
									<div class="inner-box">
										<div class="content">
											...
											<div class="text">C’est un coaching de courte durée avec des séances rapprochées.</div>
										</div>
									</div>
								</div>
				...
				<div class="skill-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="sec-title">
							...
							<div class="text">Dans le coaching professionnel, le coach appréhende donc le coaché en tant qu’individu membre d’un groupe professionnel. Il s’intéresse exclusivement à sa dimension personnelle immergée dans sa dimension professionnelle.</div>
						</div>
