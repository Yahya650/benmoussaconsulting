            ...
            <div class="row clearfix">
                ...
                <div class="course-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="https://youtu.be/H9QqaVrSDK0?si=rhlPE_0RHr2_-l5O"  class="lightbox-image overlay-box"><img class="transition-500ms"
                                    src="/web/images/benmoussa-radio.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <h5><a href="https://youtu.be/H9QqaVrSDK0?si=rhlPE_0RHr2_-l5O"  class="lightbox-image overlay-box">Comment convaincre les gens</a></h5>
                            <ul class="post-info">
                ...
                <div class="course-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="150ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="https://youtu.be/ACmDMOg-iK4?si=NswF92zTPqD9MVf0" class="lightbox-image overlay-box"><img class="transition-500ms"
                                    src="/web/images/coach-chada-3.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <h5><a href="https://youtu.be/ACmDMOg-iK4?si=NswF92zTPqD9MVf0" class="lightbox-image overlay-box">Comment obtenir un "oui" de ton mari/femme</a></h5>
                            <ul class="post-info">
                ...
                <div class="course-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="https://youtu.be/iwcf3gv_Zc4?si=woTE7CPv0DYY1iON"  class="lightbox-image overlay-box"><img class="transition-500ms"
                                    src="/web/images/coach-chada-1.png" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <h5><a href="https://youtu.be/iwcf3gv_Zc4?si=woTE7CPv0DYY1iON"  class="lightbox-image overlay-box">Différence entre les femmes et les hommes</a></h5>
                            <ul class="post-info">
                ...
                <div class="course-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="450ms" data-wow-duration="1500ms">
                        ...
                        <div class="lower-content">
                            <h5><a href="https://youtu.be/0pKUSbq3SS0?si=OpHHKQwE0GFi4Wup" class="lightbox-image overlay-box">Narcissisme avec Coach Benmoussa</a></h5>
                            <ul class="post-info">
                            ...
                            <form method="post" action="">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="theme-btn btn-style-three"><span
                                            class="txt">Prendre Rendez-Vous</span></button>
                                </div>
                            </form>
                        </div>
