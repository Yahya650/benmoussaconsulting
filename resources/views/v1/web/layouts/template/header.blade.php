        ...
        <div class="auto-container">
            <div class="inner-container clearfix">
                ...
                <div class="top-right pull-right clearfix">
                    ...
                    <div class="text">Appelez pour une consultation gratuite: <a href="tel:++212663520502">+212 663-520502</a></div>
                </div>
    ...
    <div class="header-lower">
        <div class="auto-container clearfix">
            ...
            <div class="pull-left logo-box">
                <div class="logo"><a href="{{route('web.home')}}"><img src="/web/images/CoachBen.png" alt="" title=""></a></div>
            </div>
                ...
                <nav class="main-menu navbar-expand-md">
                    ...
                    <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                        <ul class="navigation clearfix">
                            ...
                            <li class="">
                                <a href="#portfolio">Cours gratuits</a> 
                            </li>
                            <li class="">
