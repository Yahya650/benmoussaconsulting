                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form class="form w-100 form-store" id="kt_sign_in_form"
                                action="{{ route('auth.signin.post') }}" data-controller="LoginController"
                                method="POST">
                                @csrf
                                <!--begin::Heading-->
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                    ...
                                    <!--begin::Link-->
                                    <a href="/../demo39/authentication/layouts/overlay/reset-password.html"
                                        class="link-primary">
                                        Forgot Password ?
                                    </a>
                                    <!--end::Link-->
                                ...
                                <div class="text-gray-500 text-center fw-semibold fs-6">
                                    ...
                                    <a href="/../demo39/authentication/layouts/overlay/sign-up.html"
                                        class="link-primary">
                                        Sign up
                                    </a>
                                </div>
                        ...
                        <div class=" d-flex flex-stack">
                            ...
                            <div class="d-flex fw-semibold text-primary fs-base gap-5">
                                <a href="/../demo39/pages/team.html" target="_blank">Terms</a>

                                <a href="/../demo39/pages/pricing/column.html" target="_blank">Plans</a>

                                <a href="/../demo39/pages/contact.html" target="_blank">Contact
                                    Us</a>
                            </div>
                            <!--end::Links-->
                        </div>
